# Versao 12: acrescenta resposta a colisao para as entidades
...
class Enemy(GameEntity):
    ...
    def draw(self):
        self.game.screen.blit(self.image, (self.rect.left, self.rect.top))
    def hit(self, other):
        # Enemy pode colidir com Player ou Laser, mas nos dois casos deve explodir
        self.game.destroy(self)
        self.game.include(Explosion(self.game, self.rect.x, self.rect.y - 16))
...
class Laser(GameEntity):
    ...
    def draw(self):
        self.game.screen.blit(self.image, (self.rect.left, self.rect.top))
    def hit(self, other):
        # como Laser só colide com Enemy, vamos sempre remover o laser no caso de colisão
        self.game.destroy(self)
...
class Game():
    ...
    def setup(self):
        ...
        # carrega a fonte padrao do PyGame
    ...
    def main_loop(self):
        ...
        while play:
            ...
            for e in self.entities:
                e.draw()
            # escreve a pontuacao
            txt = self.font.render(str(self.score), False, (255, 255, 255))
